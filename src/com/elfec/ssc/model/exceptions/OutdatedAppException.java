...
public class OutdatedAppException extends Exception {
	...
	public String getMessage() {
		return "No se pudo comunicar con los servicios debido a que la versión de la aplicación no es la más actual. "
				+ "Le recomendamos descargar la <b>última versión</b> de la playstore: <a href=\"https://play.google.com/store/apps/details?id=com.elfec.ssc&hl=es-419/\">Obtener última versión</a>.";
	}
}
