...
public class SuperToast {
     ...
     *
     * @param context          {@link android.content.Context}
     * @param stringId {@link int}
     * @param durationInteger  {@link com.github.johnpersano.supertoasts.SuperToast.Duration}
     *
     * @return {@link SuperToast}
     */
    public static SuperToast create(Context context, int stringId,
	            int durationInteger)
    {
		return create(context, context.getResources().getString(stringId),durationInteger);
	}
    ...
    public static SuperToast create(Context context, int stringId,
                                              int durationInteger, Animations animations) {
    	return create(context, context.getResources().getString(stringId),durationInteger, animations);
    }
     ...
     * @return SuperCardToast
     */
    public static SuperToast create(Context context, int stringId, int durationInteger, Style style) {
    	return create(context, context.getResources().getString(stringId), durationInteger, style);
    }
